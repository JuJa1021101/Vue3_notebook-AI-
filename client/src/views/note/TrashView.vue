<template>
  <div class="bg-gray-50 h-screen flex flex-col overflow-hidden">
    ...
    <div class="bg-white px-4 py-3 border-b border-gray-100 flex-shrink-0">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <h1 class="text-lg font-semibold text-gray-900">回收站</h1>
          <span class="text-sm text-gray-500">({{ deletedNotes.length }})</span>
        </div>
        <button
    ...
    <div
      v-if="editMode"
      class="bg-white px-4 py-3 border-b border-gray-100 flex items-center justify-between"
    >
    ...
    >
      <div class="text-center">
        ...
        <p class="text-sm text-gray-400 mt-2">删除的笔记会在这里保留 30 天</p>
      </div>
    </div>
    ...
    <div v-else class="flex-1 overflow-y-auto p-4">
      <div class="space-y-3 pb-24">
        <div
          ...
          :class="{ 'ring-2 ring-blue-500': selectedNotes.includes(note.id) }"
        >
          <div class="p-4">
            <div class="flex items-start justify-between mb-2">
              ...
              <button
                ...
                class="ml-2 p-2 text-blue-600 hover:bg-blue-50 rounded-lg flex-shrink-0 self-center"
                title="还原"
              >
    ...
    >
      <div class="bg-white rounded-lg shadow-xl w-80 mx-4" @click.stop>
        ...
        <div class="px-6 py-4">
          ...
          <p class="text-sm text-red-600">⚠️ 此操作不可逆，笔记将永久删除！</p>
        </div>
        <div
